...
GRUB=grub-mkrescue
CFLAGS=-ffreestanding -m32 -fno-pie -mno-red-zone -mgeneral-regs-only -fno-exceptions -I src -I src/video -I src/video/character_data -I src/gdt -I src/libc -I src/idt -I src/ps2 -I src/game
