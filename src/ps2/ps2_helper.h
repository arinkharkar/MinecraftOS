...
constexpr int PS2_ACK = 0xFA;
constexpr int PS2_RESEND = 0xFE;
constexpr int PS2_DATA_PORT = 0x60;
constexpr int PS2_STATUS_PORT = 0x64;
constexpr int PS2_COMMAND_REGISTER = 0x64;

constexpr int PS2_TEST_CONTROLLER_CMD = 0xAA;
constexpr int PS2_TEST_FIRST_PORT = 0xAB;
constexpr int PS2_TEST_SECOND_PORT = 0xA9;
constexpr int PS2_ENABLE_FIRST_PORT = 0xAE;
constexpr int PS2_DISABLE_FIRST_PORT = 0xAD;
constexpr int PS2_RESET_DEVICES = 0xFF;
constexpr int PS2_RESET_DEVICE = 0xFF;

constexpr int PS2_DISABLE_SECOND_PORT = 0xA7;
constexpr int PS2_ENABLE_SECOND_PORT = 0xA8;

constexpr int PS2_GET_CONTROLERCONFIG_BYTE = 0x20;
constexpr int PS2_SET_CONTROLERCONFIG_BYTE = 0x60;

constexpr int PS2_RESET_RESPONSE_SUCCESS1 = 0xFA;
constexpr int PS2_RESET_RESPONSE_SUCCESS2 = 0xAA;

constexpr int PS2_ENABLE_SECOND_CHANNEL = 0xA8;

constexpr int PS2_RESET_RESPONSE_FAIL = 0xFC;

constexpr int PS2_CONTROLLER_TEST_PASSED = 0x55;
constexpr int PS2_CONTROLLER_TEST_FAILED = 0xFC;

constexpr int PS2_WRITE_TO_PORT2 = 0xD4;

constexpr int PS2_DEVICE_DISABLE_SCANNING = 0xF5;
constexpr int PS2_DEVICE_SET_DEFAULTS = 0xF6;
constexpr int PS2_DEVICE_ENABLE_SCANNING = 0xF4;
constexpr int PS2_DEVICE_IDENTIFY = 0xF2;

constexpr int PS2_MOUSE_SET_SAMPLE_RATE = 0xF3;
constexpr int PS2_MOUSE_GET_MOUSE_ID = 0xF2;

constexpr int PS2_TEST_FIRST_PORT_PASSED = 0x00;
